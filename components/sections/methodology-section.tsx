      ...
      <div className="content-wrap">
        ...
        <div className="methodology-sequence" data-method-step={active + 1}>
          <div className="method-chambers" aria-label="Conceptual methodology animation">
            ...
            <svg className="method-mini-graph" viewBox="0 0 500 120" role="img" aria-label="Conceptual response trends, not measured data"><path d="M8 92 C100 90 110 22 175 28 S310 73 492 88" /><path d="M8 92 C100 90 110 22 175 28 S255 84 492 93" /></svg>
          </div>
          <div className="method-chapter-copy" aria-live="polite"><span>{String(active + 1).padStart(2, "0")}</span><h3>{methodologySteps[active].title}</h3><p>{methodologySteps[active].detail}</p></div>
