...
await capture("/", "home-desktop.png", desktop, { wait: 1200 });
await capture("/", "home-mobile.png", mobile, { wait: 900 });
...
await capture("/", "motion-future.png", desktop, { scrollWithin: { selector: "#future", amount: 900 } });
await capture("/", "motion-closing.png", desktop, { focus: ".closing-section" });
